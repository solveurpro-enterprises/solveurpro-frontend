...
const Home = () => {
  return (
    <div className="min-h-screen mx-4">
        {/* hero section */}
      <section className="flex items-center min-h-screen  w-full transition-all duration-300">
        <div className="text-black  w-1/2">
          <p className="text-gray-500 flex gap-4 items-center font-extrabold mb-2"> <FaBookOpen/>Best Tutors Providing Platform</p>
          <h1 className="text-6xl font-bold text-gray-900 [text-shadow:5px_5px_5px_rgba(59,130,246,0.7)] ">
            Getting Best <br /> Quality Education <br /> Is Now More Easier
          </h1>
          <p className="text-gray-700 font-extrabold mt-4">
            A tutor-providing platform that allows anyone to teach and <br/>students
            to learn from industry professionals.
          </p>
          <div className="flex my-4">
            <button className="px-4 py-2 text-black rounded-lg text-white bg-[#525FE1] font-bold  cursor-pointer shadow-2xl shadow-black transition-all duration-300 hover:scale-90">
              Join Now
            </button>
        ...
        <div className="h-screen flex items-center justify-center  w-1/2  relative rounded-lg">
          ...
          <img src={blueWave} alt="" className="w-32 absolute top-90 right-10 rotate-90" />
            <img src={img} alt="" className=" h-96 scale-125 mt-22 drop-shadow-[0px_5px_10px_rgba(59,130,246,0.7)] rounded-lg" />
        </div>
      </section>

      {/* achivement section */}
      <section className="bg-[#525FE1] grid grid-cols-4 py-12 items-center justify-center rounded-lg shadow-lg shadow-black ">
        {
      ...
      {/* Quality seciton */}
      <section className="grid grid-cols-4 gap-4 items-center my-4 transition-all duration-300">
        <div className="text-black col-span-2 my-8">
          <h1 className="text-5xl font-bold [text-shadow:5px_5px_5px_rgba(59,130,246,0.7)] ">Why We Are Best<br/> From Others?</h1>
          <h2 className="font-bold italic mt-4">Our platform allows students to find tutors that match their <br/>learning style, needs, and schedule.</h2>
        ...
        </div>
        {
          qualities.map((quality,index)=>(
            <div className="text-white flex flex-col justify-center gap-2 border-2 p-4 rounded-xl shadow-black  shadow-2xl text-black transition-all duration-300 hover:-translate-y-4  " key={index}>
      ...
      {/* course category */}
      <section className=" text-black transition-all duration-300">
        ...
        <div className="flex justify-center gap-8 items-center my-10">
          ...
          {/* //tutors list */}
      <section className="text-black mb-4 transition-all duration-300">
      ...
      <section className="w-full flex items-center justify-center my-15 gap-4">
